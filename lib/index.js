...
class KarmiaUtilityString {
    ...
    constructor() {
        ...
        self.camel_case = KarmiaUtilityString.camel_case;
        self.snake_case = KarmiaUtilityString.snake_case;
        self.kebab_case = KarmiaUtilityString.kebab_case;
        self.parse = KarmiaUtilityString.parse;
        self.to_boolean = KarmiaUtilityString.to_boolean;
    }
     ...
     * @returns {string}
     */
    static camel_case(words, capitalize) {
